...
def BuildPTC( *args, **kargs ):
    ...
    =======
    """
    from helpers.pcshelper import BuildPTC_Helper
    helper = BuildPTC_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
#==============================================================================
...
def SetTMparam( *args, **kargs ):
    ...
    return helper.execute(*args, **kargs)
#==============================================================================
def IsAlarmed( *args, **kargs ):
    """
    Check if parameter is alarmed.

    Syntax 1:
    =========

       True|False = IsAlarmed( 'ParamName' )
    ...
    True if parameter limits are active and is not Nominal.
    False in any other case.
    """
    from helpers.limhelper import IsAlarmed_Helper
    helper = IsAlarmed_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
def GetLimits( *args, **kargs ):
    ...
    =========
       ...
       {'ApplicabilityCriteriaID': {OOL Definition values} } = GetLimits( 'ParamName' )

    Syntax 2:
    =========

       {'ApplicabilityCriteriaID': {OOL Definition values} } = GetLimits( 'Param', Select=ALL )
       {'ApplicabilityCriteriaID': {OOL Definition values} } = GetLimits( 'Param', Select=ACTIVE )
       {OOL Definition values} = GetLimits( 'Param', Select='ApplicabilityCriteriaName' )

    Syntax 3:
    =========

       <value> = GetLimits( 'Param', Select='ApplicabilityCriteriaName', Value=LoRed )
    ...
    The requested OOL definition values.
    """
    from helpers.limhelper import GetLimits_Helper
...
def SetLimits( *args, **kargs ):
    """
    Set a TM parameter limits.

    Syntax 1:
    =========

    Set the alarm limits configuration for the given TM parameter providing limit parameter.

        - For analog limit:
        <True/False> = SetLimits( <tm item/name>, Select = [ALL, ACTIVE, 'ApplicabilityCriteriaID'], LoRed=<LoRed>, Lo=<LoYel>, HiYel=<HiYel>, HiRed=<HiRed>, )
        <True/False> = SetLimits( <tm item/name>, Select = [ALL, ACTIVE, 'ApplicabilityCriteriaID'], MidPoint=<midpoint>, Tolerance=<tolerance> )

        - For Spike limit:
        <True/False> = SetLimits( <tm item/name>, Select = [ALL, ACTIVE, 'ApplicabilityCriteriaID'], Delta=<spike> )

        - For Step limit:
        <True/False> = SetLimits( <tm item/name>, Select = [ALL, ACTIVE, 'ApplicabilityCriteriaID'], Delta=<step1, step2> )

        - For Status limit:
        <True/False> = SetLimits( <tm item/name>, Select = [ALL, ACTIVE, 'ApplicabilityCriteriaID'], Nominal=['nominal1','nominal2'], Warning=['warning1'], Error=['error1'] )


    Syntax 2:
    =========

    Set the alarm limits configuration for the given TM parameter, providing
    a limit definition dictionary:


        <True/False> = SetLimits( <tm item/name>, Select = [ALL, ACTIVE, 'ApplicabilityCriteriaID'], Definition=<LimitDefinition> )
    ...
    Set the alarm limits configuration for the given TM parameter, providing
    more than one limit definition in a dictionary:


        <True/False> = SetLimits( <tm item/name>, Select = [ALL, ACTIVE, 'ApplicabilityCriteriaID'], Limits=<LimitsDefinitions> )
    ...
    """
    from helpers.limhelper import SetLimits_Helper
...
def LoadLimits( *args, **kargs ):
    ...
    True if the operation is successful.
    """
    from helpers.limhelper import LoadLimits_Helper
...
def RestoreNormalLimits( *args, **kargs ):
    ...
    True if the operation is successful.
    """
    from helpers.limhelper import RestoreNormalLimits_Helper
...
#==============================================================================
def CreateGoldenImage( *args, **kargs ):
    from helpers.memhelper import CreateGoldenImage_Helper
    helper = CreateGoldenImage_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
#==============================================================================
def DataObjectLookup( *args, **kargs ):
    from helpers.memhelper import DataObjectLookup_Helper
    helper = DataObjectLookup_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )

#==============================================================================
def DataItemLookup( *args, **kargs ):
    from helpers.memhelper import DataItemLookup_Helper
    helper = DataItemLookup_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )

#==============================================================================
def GetObjectIDs( *args, **kargs ):
    from helpers.memhelper import GetObjectIDs_Helper
    helper = GetObjectIDs_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
#==============================================================================
def UpdateCortexConf( *args, **kargs ):
    from helpers.rnghelper import UpdateCortexConf_Helper
    helper = UpdateCortexConf_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )

#==============================================================================
def ResetDriver( *args, **kargs ):
    from helpers.tchelper import ResetDriver_Helper
    helper = ResetDriver_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
def PCS_GetStatus( *args, **kargs ):
    ...
    """
    from helpers.pcshelper import PCS_GetStatus_Helper
    helper = PCS_GetStatus_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
def PCS_IsArqEnabled( *args, **kargs ):
    ...
    False in any other case.
    """
    from helpers.pcshelper import PCS_IsArqEnabled_Helper
    helper = PCS_IsArqEnabled_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
def PCS_IsVerifyModeEnabled( *args, **kargs ):
    ...
    """
    from helpers.pcshelper import PCS_IsVerifyModeEnabled_Helper
    helper = PCS_IsVerifyModeEnabled_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
def PCS_AbortPtc( *args, **kargs ):
    ...
    """
    from helpers.pcshelper import PCS_AbortPtc_Helper
    helper = PCS_AbortPtc_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
def PCS_Send( *args, **kargs ):
    ...
    """
    from helpers.pcshelper import PCS_Send_Helper
    helper = PCS_Send_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
def PCS_Control( *args, **kargs ):
    ...
    Same as Send.
    """
    from helpers.pcshelper import PCS_Control_Helper
    helper = PCS_Control_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
...
def PCS_ReadyToCommand( *args, **kargs ):
    ...
    False in any other case.
    """
    from helpers.pcshelper import PCS_ReadyToCommand_Helper
    helper = PCS_ReadyToCommand_Helper()
    helper.configure( *args, **kargs )
    return helper.execute( *args, **kargs )
