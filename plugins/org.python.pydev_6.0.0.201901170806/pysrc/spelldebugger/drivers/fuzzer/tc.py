...
class TcInterface(superClass):
    ...
    def setup(self, ctxConfig, drvConfig):
        ...
        LOG("Setup fuzzer TC interface")

    #==========================================================================
    def cleanup(self):
        superClass.cleanup(self)
        LOG("Cleanup fuzzer TC interface")
    ...
    def driverPerformAction(self, code):
        if code == 'J':
            REGISTRY['CIF'].write("fuzzer driver example action", {Severity:WARNING})
            return [False,True]
        return [False,False]

    #===========================================================================
    def driverBeforeAction(self, code):
        REGISTRY['CIF'].write("fuzzer driver before action '" + str(code) + "'", {Severity:WARNING})

    #===========================================================================
    def driverAfterAction(self, code):
        REGISTRY['CIF'].write("fuzzer driver after action '" + str(code) + "'", {Severity:WARNING})
    ...
    def _sendList(self, tcItemList, config = {} ):
        ...
        return self.__fakeComplexExecution(fakeCommand,tcItemList)
    ...
    def __fakeExecution(self, item):
        ...
        REGISTRY['SIM'].executeCommand(item)
    ...
    #==========================================================================
    def __fakeComplexExecution(self, item,tcItemList):
        ...
        for simpleItem in itemList:
            ...
            while resendCommand:
                try:
                    REGISTRY['SIM'].executeCommand(tcItemList[int(idx)])
