...
ACCEPTED_ARG_HANDLERS = [
    ...
    ArgHandlerWithParam('use-remote-port', int, 0),
    ArgHandlerWithParam('vm_type'),
    ArgHandlerWithParam('client'),
    ArgHandlerWithParam('tmtc-db-server',lambda x:base64.standard_b64decode(x),''),

    ArgHandlerBool('server'),
    ArgHandlerBool('use-remote-driver'),
    ArgHandlerBool('use-step-filter'),
